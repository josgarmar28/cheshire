...
public class file_dedupe_range_info {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_LONG_LONG.withName("dest_fd"),
        liburing_h.C_LONG_LONG.withName("dest_offset"),
        liburing_h.C_LONG_LONG.withName("bytes_deduped"),
        liburing_h.C_INT.withName("status"),
        liburing_h.C_INT.withName("reserved")
