...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, liburing_h.C_POINTER).withName("__locales"),
        liburing_h.C_POINTER.withName("__ctype_b"),
        liburing_h.C_POINTER.withName("__ctype_tolower"),
        liburing_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, liburing_h.C_POINTER).withName("__names")
