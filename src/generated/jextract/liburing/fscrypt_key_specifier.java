...
public class fscrypt_key_specifier {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_INT.withName("type"),
        liburing_h.C_INT.withName("__reserved"),
        fscrypt_key_specifier.u.layout().withName("u")
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(32, liburing_h.C_CHAR).withName("__reserved"),
            MemoryLayout.sequenceLayout(8, liburing_h.C_CHAR).withName("descriptor"),
            MemoryLayout.sequenceLayout(16, liburing_h.C_CHAR).withName("identifier")
        ).withName("$anon$108:2");
