...
public class sigcontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_LONG.withName("r8"),
        liburing_h.C_LONG.withName("r9"),
        liburing_h.C_LONG.withName("r10"),
        liburing_h.C_LONG.withName("r11"),
        liburing_h.C_LONG.withName("r12"),
        liburing_h.C_LONG.withName("r13"),
        liburing_h.C_LONG.withName("r14"),
        liburing_h.C_LONG.withName("r15"),
        liburing_h.C_LONG.withName("rdi"),
        liburing_h.C_LONG.withName("rsi"),
        liburing_h.C_LONG.withName("rbp"),
        liburing_h.C_LONG.withName("rbx"),
        liburing_h.C_LONG.withName("rdx"),
        liburing_h.C_LONG.withName("rax"),
        liburing_h.C_LONG.withName("rcx"),
        liburing_h.C_LONG.withName("rsp"),
        liburing_h.C_LONG.withName("rip"),
        liburing_h.C_LONG.withName("eflags"),
        liburing_h.C_SHORT.withName("cs"),
        liburing_h.C_SHORT.withName("gs"),
        liburing_h.C_SHORT.withName("fs"),
        liburing_h.C_SHORT.withName("__pad0"),
        liburing_h.C_LONG.withName("err"),
        liburing_h.C_LONG.withName("trapno"),
        liburing_h.C_LONG.withName("oldmask"),
        liburing_h.C_LONG.withName("cr2"),
        MemoryLayout.unionLayout(
            liburing_h.C_POINTER.withName("fpstate"),
            liburing_h.C_LONG.withName("__fpstate_word")
        ).withName("$anon$167:17"),
        MemoryLayout.sequenceLayout(8, liburing_h.C_LONG).withName("__reserved1")
    ).withName("sigcontext");
