...
public class _fpstate {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_SHORT.withName("cwd"),
        liburing_h.C_SHORT.withName("swd"),
        liburing_h.C_SHORT.withName("ftw"),
        liburing_h.C_SHORT.withName("fop"),
        liburing_h.C_LONG.withName("rip"),
        liburing_h.C_LONG.withName("rdp"),
        liburing_h.C_INT.withName("mxcsr"),
        liburing_h.C_INT.withName("mxcr_mask"),
        MemoryLayout.sequenceLayout(8, _fpxreg.layout()).withName("_st"),
        MemoryLayout.sequenceLayout(16, _xmmreg.layout()).withName("_xmm"),
        MemoryLayout.sequenceLayout(24, liburing_h.C_INT).withName("__glibc_reserved1")
    ).withName("_fpstate");
    ...
    public static void _st(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, _st(struct, index0), 0L, _fpxreg.layout().byteSize());
    }
    ...
    public static void _xmm(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, _xmm(struct, index0), 0L, _xmmreg.layout().byteSize());
    }
