...
public class fscrypt_add_key_arg {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        liburing_h.C_INT.withName("raw_size"),
        liburing_h.C_INT.withName("key_id"),
        MemoryLayout.sequenceLayout(8, liburing_h.C_INT).withName("__reserved"),
        MemoryLayout.sequenceLayout(0, liburing_h.C_CHAR).withName("raw")
