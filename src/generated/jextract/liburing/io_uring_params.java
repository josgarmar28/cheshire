...
public class io_uring_params {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_INT.withName("sq_entries"),
        liburing_h.C_INT.withName("cq_entries"),
        liburing_h.C_INT.withName("flags"),
        liburing_h.C_INT.withName("sq_thread_cpu"),
        liburing_h.C_INT.withName("sq_thread_idle"),
        liburing_h.C_INT.withName("features"),
        liburing_h.C_INT.withName("wq_fd"),
        MemoryLayout.sequenceLayout(3, liburing_h.C_INT).withName("resv"),
