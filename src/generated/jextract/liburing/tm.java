...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_INT.withName("tm_sec"),
        liburing_h.C_INT.withName("tm_min"),
        liburing_h.C_INT.withName("tm_hour"),
        liburing_h.C_INT.withName("tm_mday"),
        liburing_h.C_INT.withName("tm_mon"),
        liburing_h.C_INT.withName("tm_year"),
        liburing_h.C_INT.withName("tm_wday"),
        liburing_h.C_INT.withName("tm_yday"),
        liburing_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        liburing_h.C_LONG.withName("tm_gmtoff"),
        liburing_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
