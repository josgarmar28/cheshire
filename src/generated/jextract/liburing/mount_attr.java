...
public class mount_attr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_LONG_LONG.withName("attr_set"),
        liburing_h.C_LONG_LONG.withName("attr_clr"),
        liburing_h.C_LONG_LONG.withName("propagation"),
        liburing_h.C_LONG_LONG.withName("userns_fd")
    ).withName("mount_attr");
