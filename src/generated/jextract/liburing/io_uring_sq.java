...
public class io_uring_sq {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_POINTER.withName("khead"),
        liburing_h.C_POINTER.withName("ktail"),
        liburing_h.C_POINTER.withName("kring_mask"),
        liburing_h.C_POINTER.withName("kring_entries"),
        liburing_h.C_POINTER.withName("kflags"),
        liburing_h.C_POINTER.withName("kdropped"),
        liburing_h.C_POINTER.withName("array"),
        liburing_h.C_POINTER.withName("sqes"),
        liburing_h.C_INT.withName("sqe_head"),
        liburing_h.C_INT.withName("sqe_tail"),
        liburing_h.C_LONG.withName("ring_sz"),
        liburing_h.C_POINTER.withName("ring_ptr"),
        liburing_h.C_INT.withName("ring_mask"),
        liburing_h.C_INT.withName("ring_entries"),
        MemoryLayout.sequenceLayout(2, liburing_h.C_INT).withName("pad")
