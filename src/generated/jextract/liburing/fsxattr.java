...
public class fsxattr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_INT.withName("fsx_xflags"),
        liburing_h.C_INT.withName("fsx_extsize"),
        liburing_h.C_INT.withName("fsx_nextents"),
        liburing_h.C_INT.withName("fsx_projid"),
        liburing_h.C_INT.withName("fsx_cowextsize"),
        MemoryLayout.sequenceLayout(8, liburing_h.C_CHAR).withName("fsx_pad")
    ).withName("fsxattr");
