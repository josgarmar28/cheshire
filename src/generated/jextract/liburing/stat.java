...
public class stat {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_LONG.withName("st_dev"),
        liburing_h.C_LONG.withName("st_ino"),
        liburing_h.C_LONG.withName("st_nlink"),
        liburing_h.C_INT.withName("st_mode"),
        liburing_h.C_INT.withName("st_uid"),
        liburing_h.C_INT.withName("st_gid"),
        liburing_h.C_INT.withName("__pad0"),
        liburing_h.C_LONG.withName("st_rdev"),
        liburing_h.C_LONG.withName("st_size"),
        liburing_h.C_LONG.withName("st_blksize"),
        liburing_h.C_LONG.withName("st_blocks"),
        timespec.layout().withName("st_atim"),
        timespec.layout().withName("st_mtim"),
        timespec.layout().withName("st_ctim"),
        MemoryLayout.sequenceLayout(3, liburing_h.C_LONG).withName("__glibc_reserved")
    ).withName("stat");
