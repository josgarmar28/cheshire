...
public class io_uring_sqe {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_CHAR.withName("opcode"),
        liburing_h.C_CHAR.withName("flags"),
        liburing_h.C_SHORT.withName("ioprio"),
        liburing_h.C_INT.withName("fd"),
        MemoryLayout.unionLayout(
            liburing_h.C_LONG_LONG.withName("off"),
            liburing_h.C_LONG_LONG.withName("addr2"),
            MemoryLayout.structLayout(
                liburing_h.C_INT.withName("cmd_op"),
                liburing_h.C_INT.withName("__pad1")
            ).withName("$anon$38:3")
        ).withName("$anon$35:2"),
        MemoryLayout.unionLayout(
            liburing_h.C_LONG_LONG.withName("addr"),
            liburing_h.C_LONG_LONG.withName("splice_off_in"),
            MemoryLayout.structLayout(
                liburing_h.C_INT.withName("level"),
                liburing_h.C_INT.withName("optname")
            ).withName("$anon$46:3")
        ).withName("$anon$43:2"),
        liburing_h.C_INT.withName("len"),
        MemoryLayout.unionLayout(
            liburing_h.C_INT.withName("rw_flags"),
            liburing_h.C_INT.withName("fsync_flags"),
            liburing_h.C_SHORT.withName("poll_events"),
            liburing_h.C_INT.withName("poll32_events"),
            liburing_h.C_INT.withName("sync_range_flags"),
            liburing_h.C_INT.withName("msg_flags"),
            liburing_h.C_INT.withName("timeout_flags"),
            liburing_h.C_INT.withName("accept_flags"),
            liburing_h.C_INT.withName("cancel_flags"),
            liburing_h.C_INT.withName("open_flags"),
            liburing_h.C_INT.withName("statx_flags"),
            liburing_h.C_INT.withName("fadvise_advice"),
            liburing_h.C_INT.withName("splice_flags"),
            liburing_h.C_INT.withName("rename_flags"),
            liburing_h.C_INT.withName("unlink_flags"),
            liburing_h.C_INT.withName("hardlink_flags"),
            liburing_h.C_INT.withName("xattr_flags"),
            liburing_h.C_INT.withName("msg_ring_flags"),
            liburing_h.C_INT.withName("uring_cmd_flags"),
            liburing_h.C_INT.withName("waitid_flags"),
            liburing_h.C_INT.withName("futex_flags"),
            liburing_h.C_INT.withName("install_fd_flags"),
            liburing_h.C_INT.withName("nop_flags")
        ).withName("$anon$52:2"),
        liburing_h.C_LONG_LONG.withName("user_data"),
        MemoryLayout.unionLayout(
            liburing_h.align(liburing_h.C_SHORT, 1).withName("buf_index"),
            liburing_h.align(liburing_h.C_SHORT, 1).withName("buf_group")
        ).withName("$anon$79:2"),
        liburing_h.C_SHORT.withName("personality"),
        MemoryLayout.unionLayout(
            liburing_h.C_INT.withName("splice_fd_in"),
            liburing_h.C_INT.withName("file_index"),
            liburing_h.C_INT.withName("optlen"),
            MemoryLayout.structLayout(
                liburing_h.C_SHORT.withName("addr_len"),
                MemoryLayout.sequenceLayout(1, liburing_h.C_SHORT).withName("__pad3")
            ).withName("$anon$91:3")
        ).withName("$anon$87:2"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                liburing_h.C_LONG_LONG.withName("addr3"),
                MemoryLayout.sequenceLayout(1, liburing_h.C_LONG_LONG).withName("__pad2")
            ).withName("$anon$97:3"),
            liburing_h.C_LONG_LONG.withName("optval"),
            MemoryLayout.sequenceLayout(0, liburing_h.C_CHAR).withName("cmd")
        ).withName("$anon$96:2")
