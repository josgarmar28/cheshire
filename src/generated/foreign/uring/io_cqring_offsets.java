...
public class io_cqring_offsets {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_INT.withName("head"),
        liburing_h.C_INT.withName("tail"),
        liburing_h.C_INT.withName("ring_mask"),
        liburing_h.C_INT.withName("ring_entries"),
        liburing_h.C_INT.withName("overflow"),
        liburing_h.C_INT.withName("cqes"),
        liburing_h.C_INT.withName("flags"),
        liburing_h.C_INT.withName("resv1"),
        liburing_h.C_LONG_LONG.withName("user_addr")
