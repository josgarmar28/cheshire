...
public class flock {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_SHORT.withName("l_type"),
        liburing_h.C_SHORT.withName("l_whence"),
        MemoryLayout.paddingLayout(4),
        liburing_h.C_LONG.withName("l_start"),
        liburing_h.C_LONG.withName("l_len"),
        liburing_h.C_INT.withName("l_pid"),
        MemoryLayout.paddingLayout(4)
    ).withName("flock");
