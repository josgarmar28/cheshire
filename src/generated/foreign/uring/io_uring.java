...
public class io_uring {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        liburing_h.C_INT.withName("ring_fd"),
        liburing_h.C_INT.withName("features"),
        liburing_h.C_INT.withName("enter_ring_fd"),
        liburing_h.C_CHAR.withName("int_flags"),
        MemoryLayout.sequenceLayout(3, liburing_h.C_CHAR).withName("pad"),
        liburing_h.C_INT.withName("pad2")
    ).withName("io_uring");
