...
public class io_uring_buf_ring {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                liburing_h.C_LONG_LONG.withName("resv1"),
                liburing_h.C_INT.withName("resv2"),
                liburing_h.C_SHORT.withName("resv3"),
                liburing_h.C_SHORT.withName("tail")
            ).withName("$anon$686:3"),
    ...
    private static final OfLong resv1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$681:2"), groupElement("$anon$686:3"), groupElement("resv1"));
    ...
    private static final OfInt resv2$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$681:2"), groupElement("$anon$686:3"), groupElement("resv2"));
    ...
    private static final OfShort resv3$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$681:2"), groupElement("$anon$686:3"), groupElement("resv3"));
    ...
    private static final OfShort tail$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$681:2"), groupElement("$anon$686:3"), groupElement("tail"));
    ...
    private static final SequenceLayout bufs$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$681:2"), groupElement("bufs"));
