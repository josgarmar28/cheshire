...
public class fscrypt_get_key_status_arg {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(6, liburing_h.C_INT).withName("__reserved"),
        liburing_h.C_INT.withName("status"),
        liburing_h.C_INT.withName("status_flags"),
        liburing_h.C_INT.withName("user_count"),
        MemoryLayout.sequenceLayout(13, liburing_h.C_INT).withName("__out_reserved")
