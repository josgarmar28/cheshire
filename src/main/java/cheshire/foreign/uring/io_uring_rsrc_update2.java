...
public class io_uring_rsrc_update2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_INT.withName("offset"),
        liburing_h.C_INT.withName("resv"),
        liburing_h.C_LONG_LONG.withName("data"),
        liburing_h.C_LONG_LONG.withName("tags"),
        liburing_h.C_INT.withName("nr"),
