...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_INT.withName("__lock"),
        liburing_h.C_INT.withName("__count"),
        liburing_h.C_INT.withName("__owner"),
        liburing_h.C_INT.withName("__nusers"),
        liburing_h.C_INT.withName("__kind"),
        liburing_h.C_SHORT.withName("__spins"),
        liburing_h.C_SHORT.withName("__elision"),
