...
public class io_uring_restriction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        liburing_h.C_SHORT.withName("opcode"),
        MemoryLayout.unionLayout(
            liburing_h.C_CHAR.withName("register_op"),
            liburing_h.C_CHAR.withName("sqe_op"),
            liburing_h.C_CHAR.withName("sqe_flags")
        ).withName("$anon$664:2"),
        liburing_h.C_CHAR.withName("resv"),
    ...
    private static final OfByte register_op$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$664:2"), groupElement("register_op"));
    ...
    private static final OfByte sqe_op$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$664:2"), groupElement("sqe_op"));
    ...
    private static final OfByte sqe_flags$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$664:2"), groupElement("sqe_flags"));
